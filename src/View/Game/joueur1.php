...
<div class="row">
    <div class="col s12">
        <h3 class="center-align teal-text text-lighten-1">A <?php echo($_SESSION['pseudoPlayer1']) ?> de jouer</h3>
    </div>
</div>
<div class="row">
    <div class="col s4">
...
<div class="row">
    <div class="col s6 grid grid6">
        ...
        <?php
            ...
            echo('<div>' . $i . '</div>');
                for ($j = 1; $j < 11; $j++) {
                    if ($_SESSION['gameBoardPlayer1'][$i][$j] === 1) {
                        echo("<div class='bateau red lighten-4'></div>");
                    } elseif ($_SESSION['gameBoardPlayer1'][$i][$j] === 2) {
                        echo("<div>&#128165;</div>");
                    } elseif ($_SESSION['gameBoardPlayer1'][$i][$j] === 3) {
                        echo("<div>&#128167;</div>");
                    } else {
                        echo("<div> </div>");
                    }
